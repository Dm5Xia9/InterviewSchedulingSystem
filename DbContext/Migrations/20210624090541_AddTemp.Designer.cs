...
namespace ISSystem.DbContext.Migrations
{
    ...
    [Migration("20210624090541_AddTemp")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ISSystem.Models.Template", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ISSystem.Models.AutoLink", b =>
                {
                    b.HasOne("ISSystem.Models.Candidate", "Candidate")
                        .WithOne("AutoLink")
                        .HasForeignKey("ISSystem.Models.AutoLink", "Id")
            ...
            modelBuilder.Entity("ISSystem.Models.Calendar", b =>
                {
                    ...
                    b.HasOne("ISSystem.Models.Template", "Template")
                        .WithMany("Calendars")
